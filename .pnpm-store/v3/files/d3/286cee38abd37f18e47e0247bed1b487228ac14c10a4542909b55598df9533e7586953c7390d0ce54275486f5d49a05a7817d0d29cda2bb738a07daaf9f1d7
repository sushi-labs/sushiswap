...
export default function GlyphDiamond<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphDiamondProps<Datum> & Omit<React.SVGProps<SVGPathElement>, keyof GlyphDiamondProps<Datum>>): JSX.Element;
