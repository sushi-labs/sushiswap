...
export default function GlyphWye<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphWyeProps<Datum> & Omit<React.SVGProps<SVGPathElement>, keyof GlyphWyeProps<Datum>>): JSX.Element;
