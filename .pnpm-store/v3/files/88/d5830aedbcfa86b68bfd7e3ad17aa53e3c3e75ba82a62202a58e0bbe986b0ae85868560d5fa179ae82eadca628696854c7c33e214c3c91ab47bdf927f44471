...
function HtmlLabel(_ref) {
  ...
  var width = titleBounds.width,
      height = titleBounds.height; // if props are provided, they take precedence over context
  ...
  var _useContext = (0, _react.useContext)(_AnnotationContext.default),
      ...
      dy = _useContext$dy === void 0 ? 0 : _useContext$dy; // offset container position based on horizontal + vertical anchor
