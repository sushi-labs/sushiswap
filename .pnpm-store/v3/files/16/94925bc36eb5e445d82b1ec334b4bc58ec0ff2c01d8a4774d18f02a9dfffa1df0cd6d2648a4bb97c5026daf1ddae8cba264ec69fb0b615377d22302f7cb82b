...
export default function GlyphCircle<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphCircleProps<Datum> & Omit<React.SVGProps<SVGPathElement>, keyof GlyphCircleProps<Datum>>): JSX.Element;
