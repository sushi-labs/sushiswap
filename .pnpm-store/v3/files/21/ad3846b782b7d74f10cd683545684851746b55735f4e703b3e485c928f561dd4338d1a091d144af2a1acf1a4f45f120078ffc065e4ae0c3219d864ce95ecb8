...
const graphiqlHTML_js_1 = tslib_1.__importDefault(require("../graphiqlHTML.js"));
...
const renderGraphiQL = (opts) => graphiqlHTML_js_1.default
...
function useGraphiQL(config) {
    ...
    const renderer = (_b = config === null || config === void 0 ? void 0 : config.render) !== null && _b !== void 0 ? _b : exports.renderGraphiQL;
    return {
