...
function getFilteredRowModel() {
  return instance => utils.memo(() => [instance.getPreFilteredRowModel(), instance.getState().columnFilters, instance.getState().globalFilter], (rowModel, columnFilters, globalFilter) => {
    ...
    return filterRowsUtils.filterRows(rowModel.rows, filterRowsImpl, instance);
  }, {
