...
export default function GlyphCross<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphCrossProps<Datum> & Omit<React.SVGProps<SVGPathElement>, keyof GlyphCrossProps<Datum>>): JSX.Element;
