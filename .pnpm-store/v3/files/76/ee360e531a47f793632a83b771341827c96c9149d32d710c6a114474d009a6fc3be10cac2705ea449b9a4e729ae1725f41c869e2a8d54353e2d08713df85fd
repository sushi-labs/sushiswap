...
function wrapSchema(subschemaConfig) {
    ...
    const transformedSchema = (0, delegate_1.applySchemaTransforms)(schema, subschemaConfig);
    return (0, delegate_1.applySchemaTransforms)(schema, subschemaConfig, transformedSchema);
}
