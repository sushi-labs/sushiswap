...
const Ordering = {
  ...
  createInstance: instance => {
    return {
      ...
      _getOrderColumnsFn: utils.memo(() => [instance.getState().columnOrder, instance.getState().grouping, instance.options.groupedColumnMode], (columnOrder, grouping, groupedColumnMode) => columns => {
