...
export default function GlyphTriangle<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphTriangleProps<Datum> & Omit<React.SVGProps<SVGPathElement>, keyof GlyphTriangleProps<Datum>>): JSX.Element;
