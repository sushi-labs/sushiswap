...
import { useQueryClient as useQueryClient$1, useIsRestoring, useQueryErrorResetBoundary, notifyManager, QueryClientProvider, InfiniteQueryObserver, parseMutationArgs, useMutation as useMutation$1, QueryObserver, QueryClient } from '@tanstack/react-query';
