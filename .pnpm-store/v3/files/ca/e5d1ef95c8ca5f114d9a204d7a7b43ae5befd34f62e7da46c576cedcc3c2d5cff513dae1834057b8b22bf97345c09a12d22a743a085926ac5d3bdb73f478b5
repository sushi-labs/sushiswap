...
var EEI = /** @class */ (function () {
    function EEI(env, state, evm, common, gasLeft, transientStorage) {
        this._env = env;
        this._state = state;
        this._evm = evm;
     ...
     */
    EEI.prototype.getBlockPrevRandao = function () {
        return new ethereumjs_util_1.BN(this._env.block.header.prevRandao);
    };
    /**
     ...
     */
    EEI.prototype.transientStorageStore = function (key, value) {
     ...
     * @param key - Storage key
     */
    EEI.prototype.transientStorageLoad = function (key) {
