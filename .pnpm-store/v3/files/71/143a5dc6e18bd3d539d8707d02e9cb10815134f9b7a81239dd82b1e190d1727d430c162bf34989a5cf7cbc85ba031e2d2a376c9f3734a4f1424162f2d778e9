...
export default function GlyphStar<Datum = unknown>({ children, className, top, left, size, ...restProps }: GlyphStarProps<Datum> & Omit<React.SVGProps<SVGPathElement>, keyof GlyphStarProps<Datum>>): JSX.Element;
