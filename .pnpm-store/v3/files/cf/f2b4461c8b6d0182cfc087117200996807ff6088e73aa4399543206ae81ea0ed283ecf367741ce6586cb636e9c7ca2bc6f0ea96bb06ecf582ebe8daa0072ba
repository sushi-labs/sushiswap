...
const typed_event_target_1 = require("@graphql-yoga/typed-event-target");
/**
 * Utility for publishing and subscribing to events.
 */
const createPubSub = (config) => {
    var _a;
    const { Event, EventTarget } = (0, typed_event_target_1.resolveGlobalConfig)(config === null || config === void 0 ? void 0 : config.event);
