...
const HardhatNetworkHDAccountsConfig = t.type(Object.assign({ mnemonic: (0, io_ts_1.optional)(t.string), accountsBalance: (0, io_ts_1.optional)(exports.decimalString), passphrase: (0, io_ts_1.optional)(t.string) }, commonHDAccountsFields));
...
const HDAccountsConfig = t.type(Object.assign({ mnemonic: t.string, passphrase: (0, io_ts_1.optional)(t.string) }, commonHDAccountsFields));
