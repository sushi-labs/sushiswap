import { transformComment, wrapWithSingleQuotes, DeclarationBlock, indent, BaseTypesVisitor, getConfigValue, normalizeAvoidOptionals, isOneOfInputObjectType, } from '@graphql-codegen/visitor-plugin-common';
