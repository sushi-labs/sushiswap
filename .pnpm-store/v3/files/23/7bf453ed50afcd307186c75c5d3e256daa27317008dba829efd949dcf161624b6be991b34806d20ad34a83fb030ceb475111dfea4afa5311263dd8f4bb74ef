...
function stitchSchemas({ subschemas = [], types = [], typeDefs, onTypeConflict, mergeDirectives, mergeTypes = true, typeMergingOptions, subschemaConfigTransforms = index_js_1.defaultSubschemaConfigTransforms, resolvers = {}, inheritResolversFromInterfaces = false, resolverValidationOptions = {}, parseOptions = {}, pruningOptions, updateResolversInPlace, schemaExtensions, }) {
    ...
    const [typeCandidates, rootTypeNameMap] = (0, typeCandidates_js_1.buildTypeCandidates)({
    ...
    schema = (0, stitchingInfo_js_1.addStitchingInfo)(schema, stitchingInfo);
    if (pruningOptions) {
        schema = (0, utils_1.pruneSchema)(schema, pruningOptions);
    }
    if (schemaExtensions) {
