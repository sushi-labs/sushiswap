...
export const SUPPORTED_CHAIN_IDS = [ChainId.ARBITRUM, ChainId.ETHEREUM, ChainId.POLYGON, ChainId.BSC]
...
export const KASHI_SUBGRAPH_NAME = {
  [ChainId.ETHEREUM]: 'sushi-labs/kashi-ethereum',
  [ChainId.POLYGON]: 'sushi-labs/kashi-polygon',
  [ChainId.ARBITRUM]: 'sushi-labs/kashi-arbitrum',
  [ChainId.BSC]: 'sushi-labs/kashi-bsc',
} as const
