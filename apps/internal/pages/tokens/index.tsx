...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  return {
    props: {
      fallback: {
        [`/internal/api/tokens?chainIds=${TOKENS_SUPPORTED_CHAIN_IDS}&filter=`]:
          tokens,
      },
      revalidate: 60,
    },
...
const TokensPage: FC<InferGetStaticPropsType<typeof getStaticProps>> = ({
  fallback,
}) => {
  return (
