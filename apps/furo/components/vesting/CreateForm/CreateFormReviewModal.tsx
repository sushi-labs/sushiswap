...
import { ZFundSourceToFundSource, useTokenFromZToken } from '../../../lib/zod'
import {
  CreateMultipleVestingFormSchemaType,
  STEP_CONFIGURATIONS_LABEL,
...
export const CreateFormReviewModal: FC<CreateFormReviewModal> = withCheckerRoot(
  ({ chainId }) => {
    ...
    const [_cliffAmount, _stepAmount] = useMemo(() => {
      if (cliffEnabled) {
        return [
          tryParseAmount(cliffAmount?.toString(), _currency),
    ...
    const formValid =
      isValid && !isValidating && Object.keys(errors).length === 0
            ...
            >
              ...
              >
                <Checker.ApproveBentobox
                  ...
                  masterContract={
                    getFuroVestingRouterContractConfig(chainId).address
                  }
                  className="col-span-3 md:col-span-2"
                >
                                  ...
                                  <List.Control>
                                    ...
                                    {_totalAmount && (
                                      <List.KeyValue flex title="Total amount">
                                        ...
                                        >
                                          <Currency.Icon
                                            currency={_totalAmount.currency}
                                            width={18}
                                            height={18}
                                          />
                                          {_totalAmount?.toSignificant(6)}{' '}
                                    ...
                                    <List className="!pt-0">
                                      <List.Control>
                                        ...
                                        >
                                          ...
                                          >
                                            <Currency.Icon
                                              currency={_cliffAmount.currency}
                                              width={18}
                                              height={18}
                                            />
                                            {_cliffAmount?.toSignificant(6)}{' '}
                                            {_cliffAmount.currency.symbol}
                                          </div>
                                        </List.KeyValue>
                                      </List.Control>
                                    </List>
                                  ...
                                  <List.Control>
                                    {_stepAmount && (
                                      ...
                                      >
                                        ...
                                        >
                                          <Currency.Icon
                                            currency={_stepAmount.currency}
                                            width={18}
                                            height={18}
                                          />
                                          {_stepAmount?.toSignificant(6)}{' '}
                                          {_stepAmount.currency.symbol}
                                        </div>
                                      </List.KeyValue>
                                    )}
                                    <List.KeyValue
