...
export const ImportZone = () => {
          ...
          if (typeof result === 'string') {
            ...
            arr?.forEach((cur) => {
              if (cur !== '') {
                ...
                console.log(Native.onChain(chain.id))
                rows.push({
                  ...
                  cliffEndDate: new Date(cliffEndDate).toISOString().slice(0, 16),
  ...
  const downloadExample = useCallback(() => {
    const encodedUri = encodeURI(
      'data:text/csv;charset=utf-8,Currency Address,Funding Source (0 = WALLET, 1 = BentoBox),Amount,Recipient,Start Date (DD-MM-YYYY),Cliff(0 = DISABLED, 1 = ENABLED),Cliff End Date (DD-MM-YYYY),Cliff Amount,Payout Interval(0=WEEKLY,1=BIWEEKLY,2=MONTHLY,3=QUARTERLY,4=YEARLY),Number of Intervals,Payout Per Interval\n0x0000000000000000000000000000000000000000,0,0.0001,0x19B3Eb3Af5D93b77a5619b047De0EED7115A19e7,08-08-2022,1,10-08-2022,0.0001,0,10,0.0001\n'
    )
