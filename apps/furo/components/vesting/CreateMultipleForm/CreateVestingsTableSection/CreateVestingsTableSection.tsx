...
export const CreateVestingsTableSection: FC<CreateVestingsTableSection> = ({
  chainId,
  onReview,
}) => {
  ...
  return (
    <div className="flex flex-col col-span-2 gap-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        {Array.isArray(formErrors?.vestings) &&
          formErrors.vestings.length > 0 && (
            <div className="border border-slate-200/5 rounded-xl px-5 py-3 text-sm flex flex-col gap-3">
              <Typography
                variant="sm"
                weight={600}
                className="border-b border-slate-200/5 pb-3"
              >
                Form Errors
              </Typography>
        ...
        <div className="flex justify-between">
          <Button
            ...
            onClick={() =>
              append({ ...CREATE_VEST_DEFAULT_VALUES, id: nanoid() })
            }
          >
            Add Item
          </Button>
  ...
  return (
    <li className="list-item">
      <div className="inline-flex items-center gap-1 text-sm font-medium text-slate-200">
        <div className="uppercase text-[10px] font-semibold text-slate-400">
          {k.toLowerCase()}
        </div>
