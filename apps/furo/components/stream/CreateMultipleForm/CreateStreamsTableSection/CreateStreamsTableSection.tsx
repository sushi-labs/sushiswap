  ...
  return (
    <div className="flex flex-col col-span-2 gap-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        {Array.isArray(_formErrors?.streams) &&
          _formErrors.streams.length > 0 && (
            <div className="flex flex-col gap-3 px-5 py-3 text-sm border border-slate-200/5 rounded-xl">
              <Typography
                variant="sm"
                weight={600}
                className="pb-3 border-b border-slate-200/5"
              >
                Form Errors
              </Typography>
        ...
        <div className="flex justify-between">
          <Button
            ...
            onClick={() =>
              append({ ...CREATE_STREAM_DEFAULT_VALUES, id: nanoid() })
            }
          >
            Add Item
          </Button>
