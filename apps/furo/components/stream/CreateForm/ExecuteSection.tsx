...
export const ExecuteSection: FC<{ chainId: FuroChainId; index: number }> =
  withCheckerRoot(({ chainId, index }) => {
    ...
    const _amount = useMemo(
      () =>
        currency
          ? tryParseAmount(amount, ZTokenToToken.parse(currency))
          : undefined,
      [amount, currency],
    )
    const _fundSource = ZFundSourceToFundSource.parse(fundSource)
    const rebase = useBentoBoxTotal(
    ...
    const onSettled = useCallback(
      async (data: SendTransactionResult | undefined) => {
        ...
        void createToast({
          ...
          summary: {
            pending: `Creating ${_amount.toSignificant(6)} ${
              _amount.currency.symbol
            } stream`,
            completed: `Created ${_amount.toSignificant(6)} ${
              _amount.currency.symbol
            } stream`,
            ...
            >
              ...
              >
                <Checker.ApproveBentobox
                  ...
                  masterContract={
                    getFuroStreamRouterContractConfig(chainId).address
                  }
                  className="col-span-3 md:col-span-2"
                >
