    ...
    async (data: SendTransactionResult | undefined) => {
      ...
      createNotification({
        ...
        summary: {
          ...
          completed: `Successfully transferred stream to ${shortenAddress(
            resolvedAddress
          )}`,
          ...
          <Button
            ...
            startIcon={
              <PaperAirplaneIcon
                width={18}
                height={18}
                className="transform rotate-45 mt-[-4px] ml-0.5"
              />
            }
            disabled={
      ...
      <Dialog open={open} onClose={() => setOpen(false)}>
        <Dialog.Content className="space-y-4 !max-w-xs !pb-4">
          ...
          <Typography variant="sm" weight={400} className="text-slate-400">
            ...
            <p className="mt-2">
              Please note that this will transfer ownership of the entire stream
              to the recipient. You will not be able to withdraw from this
              stream after transferring
            </p>
          </Typography>
          ...
          <Button
            ...
            disabled={
              ...
              resolvedAddress.toLowerCase() ==
                stream?.recipient.id.toLowerCase()
            }
