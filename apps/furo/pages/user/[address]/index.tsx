...
export const getServerSideProps: GetServerSideProps<Props> = async ({
  ...
  return {
    props: {
      fallback: {
        [`/api/user/${chainId}/${query.address}/streams`]: await getUserStreams(
          chainId,
          query.address
        ),
        [`/api/user/${chainId}/${query.address}/vestings`]:
          await getUserVestings(chainId, query.address),
      },
    },
  };
};
