...
export default async function handler(
  ...
  const [sushiPrice, bentoTVL, legacyExchangeData, tridentExchangeData] =
    await Promise.all([
  ...
  const totalVolume =
    legacyExchangeData.volumeUSD + tridentExchangeData.volumeUSD;
  const totalPoolCount =
    legacyExchangeData.pairCount + tridentExchangeData.poolCount;
