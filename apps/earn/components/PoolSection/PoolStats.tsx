      ...
      <div className="flex flex-col gap-1 p-3 rounded-md shadow-md bg-slate-800 shadow-black/20">
        ...
        {pair.liquidity1dChange ? (
          <Typography
            variant="xs"
            weight={500}
            className={pair.liquidity1dChange > 0 ? "text-green" : "text-red"}
          >
      ...
      <div className="flex flex-col gap-1 p-3 rounded-md shadow-md bg-slate-800 shadow-black/20">
        ...
        {pair.volume1dChange ? (
          <Typography
            variant="xs"
            weight={500}
            className={pair.volume1dChange > 0 ? "text-green" : "text-red"}
          >
      ...
      <div className="flex flex-col gap-1 p-3 rounded-md shadow-md bg-slate-800 shadow-black/20">
        ...
        {pair.txCount1dChange ? (
          <Typography
            variant="xs"
            weight={500}
            className={pair.txCount1dChange > 0 ? "text-green" : "text-red"}
          >
