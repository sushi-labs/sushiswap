          ...
          <>
            ...
            {westHandleInView ? (
              ...
              >
                ...
                >
                  <rect fill="currentColor" className="text-slate-800" y="0" x="-30" height="30" width="60" rx="8" />
                  <text
                    textAnchor="middle"
                    fontSize="13px"
                    fill="currentColor"
            ...
            {eastHandleInView ? (
              <g transform={`translate(${xScale(localBrushExtent[1])}, 0), scale(${flipEastHandle ? '-1' : '1'}, 1)`}>
                ...
                >
                  <rect fill="currentColor" className="bg-slate-800" y="0" x="-30" height="30" width="60" rx="8" />
                  <text
                    textAnchor="middle"
                    fontSize="13px"
                    fill="currentColor"
