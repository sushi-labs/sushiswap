...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const [swaps, swapsCount, mints, mintsCount, burns, burnsCount] = await Promise.all([
    getSwaps(pair.chainId, pair.address),
    getSwapsCount(pair.chainId, pair.address),
    getMints(pair.chainId, pair.address),
    getMintsCount(pair.chainId, pair.address),
    getBurns(pair.chainId, pair.address),
    getBurnsCount(pair.chainId, pair.address),
  ])
