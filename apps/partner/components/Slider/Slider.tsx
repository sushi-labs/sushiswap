...
const Track: React.ComponentProps<typeof ReactSlider>["renderTrack"] = (
  props
) => (
  <div
    {...props}
...
const Thumb: React.ComponentProps<typeof ReactSlider>["renderThumb"] = (
  props
) => (
  <div key={props.key}>
    <div
...
export const Slider: FC<Slider> = forwardRef<ReactSlider, Slider>(
