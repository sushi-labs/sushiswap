;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [962],
  {
    50690: (e, n, t) => {
      ...
      function b(e, n, t, r) {
        var l = Object.hasOwn(g, n) ? g[n] : null
        ;(null !== l
          ? 0 !== l.type
          : r ||
            !(2 < n.length) ||
      ...
      function Bn(e) {
        ...
        while (0 < Fn.length && null === (t = Fn[0]).blockedOn)
      ...
      function Cr(e) {
        ...
        var n,
          t = Sr[e]
        for (n in t) if (Object.hasOwn(t, n) && n in Er) return (xr[e] = t[n])
        return e
      }
      c &&
            ...
            if (
              ...
              if (
                ...
                e: {
                  ...
                  while (0 < m - p) (c = qr(c)), m--
                  while (0 < p - m) (d = qr(d)), p--
                  while (m--) {
      ...
      var $a = {
        isMounted: (e) => !!(e = e._reactInternals) && je(e) === e,
      ...
      var ao = {
        ...
        uo = {
          readContext: Ca,
          useCallback: (e, n) => (
            (Cu().memoizedState = [e, void 0 === n ? null : n]), e
          ),
          useContext: Ca,
          useEffect: ju,
        ...
        oo = {
          ...
          useTransition: () => [Nu(Pu)[0], _u().memoizedState],
          useMutableSource: Tu,
        ...
        io = {
          ...
          useTransition: () => [zu(Pu)[0], _u().memoizedState],
          useMutableSource: Tu,
          useSyncExternalStore: Lu,
          useId: Ju,
          unstable_isNewReconciler: !1,
        ...
        (Mo = (e, n, t, r) => {
          ...
          if (l !== r) {
            ...
            for (c in (ye(t, r), (t = null), l))
              if (!Object.hasOwn(r, c) && Object.hasOwn(l, c) && null != l[c])
                if ('style' === c) {
                  var i = l[c]
                  for (a in i)
                    Object.hasOwn(i, a) && (t || (t = {}), (t[a] = ''))
                } else
            ...
            for (c in r) {
              ...
              if (
                ((i = null != l ? l[c] : void 0),
                Object.hasOwn(r, c) && s !== i && (null != s || null != i))
              )
                if ('style' === c)
                  if (i) {
                    for (a in i)
      ...
      var nc = { usingClientEntryPoint: !1, Events: [bl, kl, wl, _e, Pe, ss] },
        ...
        rc = {
          ...
          findHostInstanceByFiber: (e) =>
            null === (e = We(e)) ? null : e.stateNode,
          findFiberByHostInstance: tc.findFiberByHostInstance || (() => null),
    ...
    95257: (e, n) => {
      ...
      ;(n.Children = {
        ...
        (n.useCallback = (e, n) => R.current.useCallback(e, n)),
        (n.useContext = (e) => R.current.useContext(e)),
        (n.useDebugValue = () => {}),
        (n.useDeferredValue = (e) => R.current.useDeferredValue(e)),
        (n.useEffect = (e, n) => R.current.useEffect(e, n)),
        (n.useId = () => R.current.useId()),
        (n.useImperativeHandle = (e, n, t) =>
          R.current.useImperativeHandle(e, n, t)),
        (n.useInsertionEffect = (e, n) => R.current.useInsertionEffect(e, n)),
        (n.useLayoutEffect = (e, n) => R.current.useLayoutEffect(e, n)),
        (n.useMemo = (e, n) => R.current.useMemo(e, n)),
        (n.useReducer = (e, n, t) => R.current.useReducer(e, n, t)),
        (n.useRef = (e) => R.current.useRef(e)),
        (n.useState = (e) => R.current.useState(e)),
        (n.useSyncExternalStore = (e, n, t) =>
          R.current.useSyncExternalStore(e, n, t)),
        (n.useTransition = () => R.current.useTransition()),
        (n.version = '18.2.0')
    },
    50959: (e, n, t) => {
      e.exports = t(95257)
