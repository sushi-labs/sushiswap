...
import { apiAdapter02To01 } from './api-adapter'
...
export const useEvmTrade = (variables: UseEvmTradeParams) => {
  const {
    chainId,
    fromToken,
    toToken,
  ...
  return useEvmTradeQuery(variables, select)
}
