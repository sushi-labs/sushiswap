...
export const TokenSelectorV2: FC<TokenSelectorV2Props> = ({
	...
	const [_selectedNetwork, setSelectedNetwork] = useState<EvmChainId | null>(selectedNetwork ?? null);
			...
			<DialogContent
				...
				<div className="relative flex flex-col w-full gap-4 p-6 overflow-x-hidden overflow-y-auto hide-scrollbar">
					...
					<DialogHeader className="!text-left mb-4">
						<DialogTitle>{isBrowse ? "Browse Tokens" : "Select Token"}</DialogTitle>
					</DialogHeader>
					{type === "sell" || isTwap ? (
					...
					<div
						...
						<TokenSelectorStatesV2
							selected={selected}
							selectedNetwork={
								_selectedNetwork && isTokenListV2ChainId(_selectedNetwork) ? _selectedNetwork : undefined
							}
							account={address}
							onSelect={_onSelect}
