...
interface CrossChainRouteProps {
  route: CrossChainRouteType
  isSelected: boolean
  onSelect: () => void
}

export const CrossChainRoute: FC<CrossChainRouteProps> = ({
  route,
  isSelected,
  onSelect,
}) => {
  ...
  return (
    ...
    >
      <CardHeader>
        ...
        <CardDescription>{`≈ ${amountOutUSD}`}</CardDescription>
      </CardHeader>
      {isSelected ? (
        <>
