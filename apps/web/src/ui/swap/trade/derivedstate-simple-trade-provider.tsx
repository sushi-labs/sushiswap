...
> = ({ children }) => {
  ...
  // useEffect(() => {
  //   const newTradeView = resolveViewModeFromPathname(pathname)
  //   if (newTradeView !== tradeView) {
  //     _setTradeView(newTradeView)
  //     _setTradeModeChanged(false)
  //     createQuery(
  //       [],
  //       `/${pathname?.split('/')[1]}/${tradeMode}${newTradeView !== 'simple' ? `/${newTradeView}` : ''}`,
  //     )
  //   }
  // }, [pathname, tradeView, chainId, tradeMode])
