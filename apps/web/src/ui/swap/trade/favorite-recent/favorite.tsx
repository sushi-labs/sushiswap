				...
				<table className="w-full">
					<thead className="sticky top-0 z-20 bg-slate-50 dark:bg-slate-900 md:dark:bg-slate-800">
						<tr className="text-xs text-slate-700 dark:text-pink-100">
							...
							<th className="font-medium text-left table-cell md:hidden">Price/24%</th>
	...
	return (
		<tr className="text-xs">
			...
			<td className="hidden md:table-cell">
				<span className="text-slate-900 dark:text-pink-100">{formatUSD(0.87)}</span>
			</td>
			<td className="hidden md:table-cell">
			...
			<td className="">
				<div className="flex flex-col items-end ml-auto">
					<span className="text-slate-900 dark:text-pink-100 !font-medium">{formatUSD(16232.5)}</span>
					<span className="text-muted-foreground">{formatNumber(82.2)} SUSHI</span>
				</div>
			</td>
		</tr>
	);
