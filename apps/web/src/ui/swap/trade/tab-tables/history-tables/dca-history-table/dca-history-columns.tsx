...
export const getAvgPriceColumn = (
  ...
  cell: ({ row }) => {
    const { avgBuyTokenAmountPerChunk, avgBuyTokenUsdPerChunk, buyToken } = useParsedOrder(
      row.original
    );
    ...
    return showInUsd ? (
      ...
      <span className="whitespace-nowrap">{!avgBuyTokenAmountPerChunk ? "N/A" : `${formatNumber(
