  ...
  return (
    <div className="grid relative z-40 grid-cols-2 col-span-2 gap-2 md:flex md:flex-row md:justify-center md:items-center md:col-span-2">
      <Button
        ...
        // }}
        size="xs"
        className="text-slate-50 !rounded-full bg-green-500 font-semibold hover:bg-green-500 active:bg-green-500/95 focus:bg-green-500 w-full md:w-[64px] h-[32px] min-h-[32px]"
      >
        BUY
      </Button>
      ...
      <Button
        ...
        size="xs"
        variant="ghost"
        className="text-slate-50 !rounded-full bg-[#EA3830] font-semibold hover:bg-[#EA3830] active:bg-[#EA3830]/95 focus:bg-[#EA3830] w-full md:w-[64px] h-[32px] min-h-[32px]"
      >
        SELL
      </Button>
