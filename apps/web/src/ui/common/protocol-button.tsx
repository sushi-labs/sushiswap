...
export const ProtocolButton = ({
	...
	const selectedColoringClassname = useMemo(() => {
		if (selectedProtocol === SushiSwapProtocol.SUSHISWAP_V2 && protocol === SushiSwapProtocol.SUSHISWAP_V2) {
			return "!bg-[#F338C31A] !border-[#F338C3] text-[#F338C3] hover:!text-[#F338C3] !border-solid";
		}
		if (selectedProtocol === SushiSwapProtocol.SUSHISWAP_V3 && protocol === SushiSwapProtocol.SUSHISWAP_V3) {
