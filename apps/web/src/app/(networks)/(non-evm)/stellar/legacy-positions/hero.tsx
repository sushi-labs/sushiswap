    ...
    <section className="flex flex-col gap-6">
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="flex flex-col gap-2">
            <p className="text-md w-[720px] text-muted-foreground">
              ...
              implementation that could lead to positions in heavily-used pools
              being locked.
            </p>
            <p className="text-md w-[720px] text-muted-foreground">
              In such a state, only fees accrued from the position can be
              collected, but the position principal itself cannot be withdrawn.
            </p>
            <p className="text-md w-[720px] text-muted-foreground">
              ...
              range) under the new fixed implementation of the position manager.
            </p>
            <div className="h-2" />
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="flex flex-col gap-2">
            <p className="text-md w-[720px] text-muted-foreground">
              Simply connect your wallet and click the "Migrate" button for each
              of your legacy positions below.
            </p>
            <p className="text-md w-[720px] text-muted-foreground">
            ...
            <ol className="list-decimal list-outside flex flex-col gap-1 pl-5">
              ...
              <li className="text-md w-[720px] text-muted-foreground">
                Withdraw the position principal and accrued fees from the legacy
                position
              </li>
              <li className="text-md w-[720px] text-muted-foreground">
            ...
            <p className="text-md w-[720px] text-muted-foreground">
              ...
              position with the same parameters, it is recommended that you take
              note of your legacy position parameters (i.e., token pair, fee
              rate, principal amounts, and price range) before initiating the
              migration as a back-up.
            </p>
            <div className="h-2" />
          </AccordionContent>
        </AccordionItem>
