...
import { useRemoveLiqDispatch, useRemoveLiqState } from "../Remove/pool-remove-provider";
...
export const PoolPosition = () => {
	...
	const { reserve0, reserve1, token0, token1, isLoadingPool, totalSupplyLP } = usePoolState();
	...
	const loading = isLoading || isLoadingPrice0 || isLoadingPrice1 || isLoadingPool;
