...
export const Icon = ({ currency, height = 40, width = 40, fontSize = 12 }: IconProps) => {
	...
	return (
		<>
			{currency?.tokenImage ? (
				<div style={{ width, height }} className="relative flex overflow-hidden rounded-full shrink-0">
					<Image
				...
				<div
					...
					style={{
						width: `${width}px`,
						height: `${height}px`,
						background: hashStringToColor(currency ? `${currency.tokenSymbol} ${currency.tokenName}` : "??"),
