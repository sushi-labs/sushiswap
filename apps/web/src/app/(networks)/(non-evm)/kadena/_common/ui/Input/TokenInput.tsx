import { Button, SelectIcon, SkeletonBox, TextField, classNames } from "@sushiswap/ui";
...
export const TokenInput = ({
	...
	const insufficientBalance = type === "input" && Number(amount) > (tokenBalance ?? 0);
		...
		<div
			...
			<div className="relative flex items-center gap-4">
				<div
					...
					{currencyLoading ? <SkeletonBox className="w-1/3 h-[32px] rounded-lg" /> : null}
				</div>
				<div
