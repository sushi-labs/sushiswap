...
export const TVL_COLUMN: ColumnDef<Pool, unknown> = {
	...
	sortingFn: ({ original: rowA }, { original: rowB }) => rowA.tvlUsd - rowB.tvlUsd,
	cell: (props) =>
		formatUSD(props.row.original.tvlUsd).includes("NaN") ? "$0.00" : formatUSD(props.row.original.tvlUsd),
	meta: {
		body: {
...
export const VOLUME_1D_COLUMN: ColumnDef<Pool, unknown> = {
	...
	sortingFn: ({ original: rowA }, { original: rowB }) => rowA.volume24hUsd - rowB.volume24hUsd,
	cell: (props) =>
...
export const TRANSACTIONS_1D_COLUMN: ColumnDef<Pool, unknown> = {
	...
	sortingFn: ({ original: rowA }, { original: rowB }) => rowA.transactionCount24h - rowB.transactionCount24h,
