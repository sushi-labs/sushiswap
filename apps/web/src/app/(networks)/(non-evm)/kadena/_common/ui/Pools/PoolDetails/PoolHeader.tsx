				...
				<div className="flex flex-wrap items-center gap-y-5 gap-x-[32px] text-secondary-foreground mb-8 mt-1.5">
					<div className="flex items-center gap-1.5">
						...
						<Popover>
							...
							<PopoverContent side="right" className="max-w-[320px] whitespace-normal text-left">
								<span className="text-xs">
									APR is calculated based on the fees generated by the pool over the last 24 hours. The APR
									displayed is algorithmic and subject to change.
								</span>
							</PopoverContent>
						</Popover>
					</div>
