...
const RemoveProvider: FC<RemoveProviderProps> = ({ children }) => {
	...
	const dispatchWithAction = useMemo(
		() => ({
			...
			setAmountToken0PerLP: (value: number) => dispatch({ type: "setAmountToken0PerLP", value }),
			setAmountToken1PerLP: (value: number) => dispatch({ type: "setAmountToken1PerLP", value }),
			setLPBalance: (value: number) => dispatch({ type: "setLPBalance", value }),
			setLPToRemove: (value: number) => dispatch({ type: "setLPToRemove", value }),
			setMinAmountToken0: (value: number) => dispatch({ type: "setMinAmountToken0", value }),
			setMinAmountToken1: (value: number) => dispatch({ type: "setMinAmountToken1", value }),
		}),
		[]
	);
