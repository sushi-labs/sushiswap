...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <Suspense fallback={null}>
      ...
      <div className="flex flex-col flex-1 overflow-y-auto overflow-x-hidden animate-slide min-h-[calc(100vh-56px)] bg-gray-50 dark:bg-white/[0.02]">
        <Container maxWidth="6xl" className="px-4 pt-8 md:pt-16 mb-6 md:mb-12">
          <Hero />
        </Container>
