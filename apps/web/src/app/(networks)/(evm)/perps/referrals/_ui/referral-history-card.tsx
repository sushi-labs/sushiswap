...
import { useSushiReferralFeeHistory } from 'src/lib/perps'
  ...
  return (
    <Card className="border-transparent !bg-[#18223B] p-2 !rounded-md">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-lg font-medium">Daily reward history</h2>
          <p className="text-sm text-slate-400">
            Simple day-by-day Sushi referral earnings.
          </p>
        </div>
      ...
      <div className="mt-4">
        {history.isLoading ? (
          ...
          <ReferralHistoryChart data={historyPoints} />
        )}
      </div>
    </Card>
  )
