...
// import { BitcoinIcon } from '@sushiswap/ui/icons/bitcoin-icon'
import { BankIcon } from '@sushiswap/ui/icons/bank-icon'
import { CirclesIcon } from '@sushiswap/ui/icons/circles-icon'
import { ClockIcon } from '@sushiswap/ui/icons/clock-icon'
import { FireIcon } from '@sushiswap/ui/icons/fire-icon'
import { InfinityIcon } from '@sushiswap/ui/icons/infinity-icon'
import { LightningIcon } from '@sushiswap/ui/icons/lightning-icon'
...
export const AssetTabs = () => {
  const [selectedTab, setSelectedTab] = useLocalStorage<TabType>(
    'sushi.perps.selected-asset-tab',
    'all',
  )
  useEffect(() => {
