...
export const TabbedView = () => {
  return (
    <Card className="p-0 h-[450px] min-h-[350px] !bg-[#0D1421] border border-[#1E2939] overflow-hidden">
      <Tabs className="w-full" defaultValue={'chart'}>
        <TabsList className="!flex !px-0 !h-8 !m-2 !mb-1">
        ...
        <TabsContent value="chart" className="h-[375px]">
          <Chart />
        </TabsContent>
