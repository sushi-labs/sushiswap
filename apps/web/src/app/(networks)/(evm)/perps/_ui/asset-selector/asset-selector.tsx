...
export const AssetSelector = () => {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent
        className="flex flex-col !p-0 lg:!rounded-xl !max-w-[100vw] md:!max-w-[960px] !shadow-[inset_1.5px_2px_1px_-2px_rgba(255,255,255,0.2),inset_-1.5px_-1.5px_1px_-2px_rgba(255,255,255,0.125)] !bg-perps-background/90 border !border-white/[0.07]"
        style={{
          backgroundImage:
