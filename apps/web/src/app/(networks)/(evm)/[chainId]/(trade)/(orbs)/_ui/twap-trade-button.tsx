...
import { useWrapNative } from 'src/lib/wagmi/hooks/wnative/use-wrap-native'
...
type CheckerButtonProps = ButtonProps & {
  enabled?: boolean
}

type WrapNativeCheckerProps = CheckerButtonProps & {
...
const TwapTradeChecker: FC<CheckerButtonProps> = ({
  id,
  children,
  className,
  fullWidth = true,
