...
import { CHAIN_IDS_BY_TRADE_MODE, type TradeMode } from "src/ui/swap/trade/config";
					...
					<Container maxWidth="screen-2xl" className="px-4">
						<div className="flex-col-reverse md:flex-row flex w-full gap-4">
							<div className="flex w-full flex-col gap-4 md:w-1/2 lg:w-[calc(100%-480px)]">
								<div className="w-full md:h-[648px] rounded-xl border">chart</div>
								<div className="w-full md:h-[320px] rounded-xl border">tables</div>
							</div>
							<div className="flex w-full flex-col gap-4 md:w-[480px]">
								...
								<TradeWidget />
								<div className="w-full h-[420px] rounded-xl border hidden md:block">fav/recent</div>
							</div>
						</div>
					</Container>
				</main>
