...
export const LAUNCHPAD_ABI = parseAbi([
  ...
  'event PositionCreated(address indexed token, address indexed pool, uint256 indexed positionId, int24 tickLower, int24 tickUpper, uint256 tokenDesired, uint256 tokenUsed, uint128 liquidity)',
  'event InitialBuyExecuted(address indexed creator, address indexed token, address indexed pool, address recipient, address quoteToken, uint256 amountIn, uint256 amountOut)',
