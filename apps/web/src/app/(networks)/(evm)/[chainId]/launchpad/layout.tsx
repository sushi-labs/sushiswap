...
export default async function LaunchpadLayout({
  ...
  return (
    <>
      ...
      />
      <AutoDarkMode />
      <div className="relative min-h-[calc(100vh-56px)] overflow-x-hidden bg-perps-background text-perps-muted [html:has(&:not([style*='display:_none']))]:!bg-perps-background">
