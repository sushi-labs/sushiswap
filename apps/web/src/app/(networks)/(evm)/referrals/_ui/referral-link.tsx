...
import { IconButton, LinkExternal, classNames } from '@sushiswap/ui'
...
export const ReferralLink = () => {
  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row items-start md:justify-between md:items-center w-full">
      <div className="flex flex-col w-full">
        <p className="text-xl font-medium">
          Invite your network to join SushiSwap
        </p>
        ...
        <div className="flex flex-col gap-2 w-full max-w-[500px]">
          <div className="relative rounded-full overflow-hidden w-full max-w-[500px] flex p-0.5">
            ...
            <input
              ...
              readOnly
              value={referralLink || ''}
              className="w-full max-w-[500px] pr-9 font-medium py-2 pl-4 z-[11] bg-gradient-to-r from-blue/10 to-pink/10 border border-transparent rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            <IconButton
              variant="default"
