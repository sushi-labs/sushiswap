  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      <span className="text-xl max-w-[720px] text-muted-foreground">
        Claim fees from your V3 and V4 liquidity positions and rewards from your
        V3 positions across supported networks.
      </span>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-5">
        ...
        <Card className="flex-1 col-span-2 md:col-span-1">
          <CardHeader className="!p-5 !pb-3">
            <span className="font-medium text-sm text-muted-foreground">
              Claimable Rewards
            </span>
