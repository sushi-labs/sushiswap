    ...
    <Container maxWidth="md" className="space-y-14">
      ...
      <div className="gap-4 flex flex-row w-full">
        ...
        <Card className="w-full">
          <CardContent className="!pt-6 flex items-center">
            <div>
              <BeakerIcon width={32} height={32} className="text-blue-500" />
            </div>
            <div className="flex flex-col items-center">
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col lg:flex-row h-full justify-between overflow-y-auto">
      <div className="hidden w-[49.5%] lg:flex justify-center items-center">
        <Hero />
      </div>
      <div className="w-full h-full lg:w-[49.5%] bg-secondary">
