...
import { Button, Container, LinkExternal, LinkInternal, typographyVariants } from "@sushiswap/ui";
import { DiscordIcon } from "@sushiswap/ui/icons/DiscordIcon";
import { PoolsView } from "~tron/_common/ui/Pools/PoolsView";
						...
						<div className="flex flex-col sm:flex-row w-full sm:w-[unset] gap-4">
							<div className="flex items-center w-full">
								<Button asChild size="lg">
									<LinkInternal href="/tron/pool/add">I want to create a position</LinkInternal>
								</Button>
							</div>
						</div>
					</div>
