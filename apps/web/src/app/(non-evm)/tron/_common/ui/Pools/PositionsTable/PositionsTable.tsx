...
import { APR_COLUMN, POSITION_NAME_COLUMN, SIZE_COLUMN, VALUE_COLUMN } from "./PositionColumns";
			...
			<CardHeader>
				<CardTitle>
					<div className="flex flex-wrap items-center justify-between gap-4">
						<span>
							My Positions <span className="text-gray-400 dark:text-slate-500">({filteredData.length})</span>
						</span>
