              ...
              <div className="flex items-end justify-center min-h-full text-center md:items-center">
                ...
                >
                  <HeadlessDialog.Panel className="w-full h-full max-w-lg px-1">
                    <div className="p-4 overflow-hidden text-left max-w-lg inline-block w-full h-full bg-gray-50 paper dark:bg-slate-800 shadow-xl align-middle transition-all transform rounded-t-2xl rounded-b-none md:rounded-2xl relative'">
