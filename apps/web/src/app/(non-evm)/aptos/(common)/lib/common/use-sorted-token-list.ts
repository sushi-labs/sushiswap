...
import { filterTokens, getSortedTokensByQuery, tokenComparator } from "./get-sorted-tokens-by-query";
...
export const useSortedTokenList = ({ query, tokenMap, customTokenMap, balanceMap }: Params) => {
