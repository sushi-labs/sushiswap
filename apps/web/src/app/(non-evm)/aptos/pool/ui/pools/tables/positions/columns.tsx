...
export const TVL_COLUMN: ColumnDef<PoolExtendedWithAprVolume, unknown> = {
	...
	cell: (props) => <PoolMyPositionTVLCell isSize={false} row={props.row.original} />,
	meta: {
		skeleton: (
			<div className="flex items-center w-full gap-2">
				<div className="flex flex-col w-full">
...
export const MYPOSITION_TVL_COLUMN: ColumnDef<PoolExtendedWithAprVolume, unknown> = {
	id: "Size",
	header: "Size",
	cell: (props) => <PoolMyPositionTVLCell isSize={true} row={props.row.original} />,
	meta: {
		skeleton: (
			<div className="flex items-center w-full gap-2">
				<div className="flex flex-col w-full">
...
export const MYPOSITION_APR_COLUMN: ColumnDef<PoolExtendedWithAprVolume, unknown> = {
	id: "APR",
	header: "APR",
