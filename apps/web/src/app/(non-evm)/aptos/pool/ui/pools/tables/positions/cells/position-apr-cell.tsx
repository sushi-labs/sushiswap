...
export const PoolMyPositionAprCell: FC<Row<PoolExtendedWithAprVolume>> = ({ row }) => {
	...
	const liquidityBalanceFormatted = Number(formatNumberWithDecimals(liquidityBalance, 8));
