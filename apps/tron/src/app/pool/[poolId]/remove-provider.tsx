...
const RemoveProvider: FC<RemoveProviderProps> = ({ children }) => {
	...
	const dispatchWithAction = useMemo(
		() => ({
			...
			setAmountToken0PerLP: (value: string) => dispatch({ type: "setAmountToken0PerLP", value }),
			setAmountToken1PerLP: (value: string) => dispatch({ type: "setAmountToken1PerLP", value }),
			setTotalSupplyLP: (value: string) => dispatch({ type: "setTotalSupplyLP", value }),
			setLPBalance: (value: string) => dispatch({ type: "setLPBalance", value }),
			setLPToRemove: (value: string) => dispatch({ type: "setLPToRemove", value }),
			setMinAmountToken0: (value: string) => dispatch({ type: "setMinAmountToken0", value }),
			setMinAmountToken1: (value: string) => dispatch({ type: "setMinAmountToken1", value }),
		}),
		[dispatch]
	);
