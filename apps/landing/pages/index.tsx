...
import { formattedNum, formattedCountUp } from '../lib/format'
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const results = await Promise.all([
        ...
        sushiData.exchange.factory(),
        //sushiData.exchange.twentyFourHourData()
      ])
      console.log(results)

      const sushiPrice = formattedCountUp(results[0], true)
        ...
        primary: [
          {
            ...
            number: Number(sushiPrice.number),
            title: '$SUSHI Price',
            decimalPlaces: 2,
            prefix: sushiPrice.prefix,
            suffix: sushiPrice.suffix,
          },
          {
    ...
    <>
      <div className="relative min-h-screen overflow-hidden" style={{ backgroundColor: '#0D0415' }}>
        ...
        >
          ...
          <div className="max-w-2xl px-5 pt-6 mx-auto sm:px-4">
            <div className="flex flex-col items-center space-y-4">
              <img
                ...
                alt=""
              />
              <div className="text-4xl font-semibold text-center text-white sm:text-5xl" style={{ maxWidth: '698px' }}>
          ...
          <div className="px-10 pt-8 mx-auto 2xl:max-w-7xl">
            <Marquee>
              {stats &&
                stats.secondary.map((stat) => {
                  return (
                    <div className="flex flex-col items-center py-8 ml-40 rounded-md px-14" key={stat.title}>
        ...
        <div className="pt-10 mx-auto 2xl:max-w-screen-2xl">
          <div className="flex flex-row items-center px-10 pt-20 pb-8 mx-auto space-x-6 overflow-x-scroll no-scrollbar">
            ...
            {/* <ProductCard
              ...
              description={
                'An innovative ecosystem to use dapps gas-efficiently and gain extra yield. Onchain mini dapps.'
              }
              cta={'Enter BentoBox'}
        ...
        <div className="max-w-2xl px-4 pt-10 mx-auto sm:pt-28">
          <div className="text-2xl font-semibold text-center text-white sm:text-4xl" style={{ maxWidth: '902px' }}>
