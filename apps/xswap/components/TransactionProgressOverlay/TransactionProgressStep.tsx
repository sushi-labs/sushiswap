...
const TransactionProgressStepHeader: FC<TransactionProgressStepHeader> = ({
  children,
}) => {
  return (
...
const TransactionProgressStepSubHeader: FC<
  TransactionProgressStepSubHeader
> = ({ icon, caption }) => {
  return (
...
export const TransactionProgressStep: TransactionProgressStepType<
    ...
    <div className={classNames("grid grid-cols-[60px_320px] mx-auto")}>
      <div className="flex flex-col items-center">
        <div className="flex items-center justify-center w-6 h-6">
          ...
          {status === "idle" && (
            <CircleIcon className="text-slate-500" width={24} height={24} />
          )}
          {status === "failed" && (
            <Tooltip
              button={
                <XCircleIcon className="text-red" width={24} height={24} />
              }
              panel={
                <div className="text-xs rounded-2xl text-slate-300">
                  Transaction Failed
