...
const DerivedstateSimpleSwapProvider: FC<DerivedStateSimpleSwapProviderProps> = ({ children }) => {
  ...
  const defaultedParams = useMemo(() => {
    ...
    if (!params.has('chainId'))
      params.set(
        'chainId',
        (chain?.id && SUPPORTED_CHAIN_IDS.includes(chain.id as ChainId) ? chain.id : ChainId.ETHEREUM).toString()
      )
...
export { DerivedstateSimpleSwapProvider, useDerivedStateSimpleSwap, useSimpleSwapTrade }
