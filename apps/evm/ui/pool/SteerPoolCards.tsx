...
export const SteerPoolCards: FC<{ params: { id: string } }> = ({ params }) => {
  const pathname = usePathname()

  return (
    <div className="flex justify-center gap-4">
      <LinkInternal href={`/pool/${params.id}/positions/create/stable-pool`}>
        <Card
      ...
      <LinkInternal href={`/pool/${params.id}/positions/create/elastic-pool`}>
        <Card
          className={classNames(
            pathname.includes('elastic-pool') ? 'border-blue' : '',
            'max-w-[400px] hover:border-blue-300 hover:shadow-md'
          )}
        >
          <CardHeader>
      ...
      <LinkInternal href={`/pool/${params.id}/positions/create/moving-volatility-pool`}>
        <Card
          className={classNames(
            pathname.includes('moving-volatility-pool') ? 'border-blue' : '',
            'max-w-[400px] hover:border-blue-300 hover:shadow-md'
          )}
        >
          {' '}
