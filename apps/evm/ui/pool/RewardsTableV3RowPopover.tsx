...
import { rewardPerDay, unwrapToken } from 'lib/functions'
...
export const RewardsTableV3RowPopover: FC<Row<AngleRewardsPool>> = ({ original }) => {
  const ongoingFarms = original.distributionData.filter((el) => el.isLive)
