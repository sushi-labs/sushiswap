        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex items-center w-full">
            <Button asChild size="lg" className="rounded-r-none">
              <Link
                href={
                  isSushiSwapV3ChainId(chainId as ChainId) ? `/pool/add?chainId=${chainId}` : `/pool/add/v2/${chainId}`
                }
              >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-80">
                <DropdownMenuGroup>
                  <DropdownMenuItem disabled={!isSushiSwapV3ChainId(chainId as ChainId)} asChild>
                    <Link
                    ...
                    >
                      <div className="flex items-center gap-1 font-medium leading-none">
                        ...
                        <Chip variant="secondary">
                          {isSushiSwapV3ChainId(chainId as ChainId) ? 'New 🔥' : 'Unavailable'}
                        </Chip>
                      </div>
