      ...
      <Container maxWidth="7xl" className="px-4">
        <div className="flex flex-wrap items-center gap-2 mb-4">
          <LinkInternal shallow={true} scroll={false} href={`/analytics`}>
            <PathnameButton id="all-pools" pathname={`/analytics`} asChild size="sm">
              Pools
            </PathnameButton>
          </LinkInternal>
          <LinkInternal shallow={true} scroll={false} href={`/analytics/pay`}>
            <PathnameButton id="my-positions" pathname={`/analytics/pay`} asChild size="sm">
              Sushi Pay
            </PathnameButton>
          </LinkInternal>
          <LinkInternal shallow={true} scroll={false} href={`/analytics/vault`}>
            <PathnameButton id="my-rewards" pathname={`/analytics/vault`} asChild size="sm">
              Sushi Vault
            </PathnameButton>
          </LinkInternal>
        </div>
