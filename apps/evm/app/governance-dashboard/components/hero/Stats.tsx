        ...
        <div className="relative h-full w-full space-y-10 rounded-lg bg-gradient-to-b from-[#101728]/40 to-transparent p-9">
          <section className="space-y-3">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-gray-50 text-3xl font-bold">${formatNumber(treasurySnapshot.totalValueUsd)}</p>
            </div>
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-baseline gap-3">
                <label className="text-sm text-slate-400">Liquid</label>
                <span className="text-gray-50 font-bold">${formatNumber(treasurySnapshot.balancesValueUsd)}</span>
              </div>
              ...
              <div className="flex items-baseline justify-end gap-3">
                ...
                <span className="text-gray-50 font-bold">${formatNumber(treasurySnapshot.vestingValueUsd)}</span>
              </div>
            </div>
          </section>
          <section className="space-y-5">
            <div className="flex justify-between">
              ...
              <div className="flex flex-col gap-1 text-right">
                ...
                <span className="text-gray-50 text-2xl font-bold">{formatNumber(forumStats?.proposalsCount)}</span>
              </div>
            </div>
            <div className="flex justify-between">
              <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1 text-right">
                ...
                <span className="text-gray-50 text-2xl font-bold">{events.length}</span>
              </div>
            </div>
          </section>
        </div>
