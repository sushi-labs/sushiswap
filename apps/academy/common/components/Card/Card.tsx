      ...
      <div className="relative h-[436px] sm:h-[446px] rounded-lg bg-slate-800/50 sm:bg-[#182030] overflow-hidden sm:ease-in-out sm:duration-300 sm:hover:scale-110 sm:hover:shadow-[4px_4px_27px_rgba(0,0,0,0.25)_0px_24px_24px_-16px_rgba(15,15,15,0.2)] sm:z-10 sm:hover:z-20">
        ...
        <div className="grid gap-4 p-6">
          <div className="flex items-center w-full gap-5">
            {product && (
              <Chip className="pl-2.5 pr-2.5 h-7" label={product.name} />
            )}
          ...
          <Typography
            variant="lg"
            weight={600}
            className="leading-5 text-slate-50 line-clamp-2"
          >
          ...
          <Typography
            variant="sm"
            className={classNames("leading-5 text-slate-400 line-clamp-3")}
          >
          ...
          <Typography
            variant="xs"
            weight={500}
            className="absolute text-slate-500 bottom-6 left-6"
          >
