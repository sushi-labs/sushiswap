    ...
    <svg width="102" height="102" viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_1794_2166" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_1794_2166" result="shape" />
        </filter>
        <linearGradient
