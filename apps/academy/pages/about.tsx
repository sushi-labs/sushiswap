          ...
          <article className="mt-10 sm:mt-[100px]">
            ...
            <div className="mt-8 sm:mt-10 grid gap-6">
              {roadmapSections.map(({ product, description, lastUpdated }) => (
                <Disclosure as="div" className="bg-slate-800/50 rounded-lg" key={product}>
                  {({ open }) => (
                    <>
                      <Disclosure.Button
                        as="div"
                      ...
                      >
                        <div className="flex justify-between">
                          <h4 className="font-semibold sm:font-bold text-lg sm:text-3xl text-slate-50">{product}</h4>
                        ...
                        <span className="sm:text-base text-slate-400">
                          Last updated on {format(new Date(lastUpdated), 'd MMM, y')}
                        </span>
                      </Disclosure.Button>
                      ...
                      >
                        <Disclosure.Panel className="px-4 py-6 sm:px-8 sm:py-8">{description}</Disclosure.Panel>
                      </Transition>
                    </>
                  )}
                </Disclosure>
