...
async function makeSwap(
  ...
  if (UPDATE_POOL_STATES) {
    ...
    Array.from(env.poolCodes.entries()).forEach((e) => {
      if (!usedPools.has(e[0]) && !(e[1] instanceof CurvePoolCode))
        pcMap.set(e[0], e[1]) //Curve is not supported by RP3
    })
  }
...
describe('End-to-end RouteProcessor3_2 test', async () => {
