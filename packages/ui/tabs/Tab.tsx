...
const _Tab: React.ForwardRefExoticComponent<
  React.PropsWithoutRef<TabButton> & React.RefAttributes<HTMLButtonElement>
> = forwardRef<HTMLButtonElement, TabButton>(
        ...
        {({ selected }) => (
          <Button
            ...
            className={classNames(
              className,
              "hover:ring-0 focus:ring-0 outline-none"
            )}
            color="gray"
