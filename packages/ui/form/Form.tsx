...
type Props = {
  header: string;
  children:
    | React.ReactElement<typeof FormSection>
    | React.ReactElement<typeof FormSection>[];
};

type FormRootProps<C extends React.ElementType> = PolymorphicComponentProps<
  C,
  Props
>;
type FormRootComponent = <C extends React.ElementType = "form">(
  props: FormRootProps<C>
