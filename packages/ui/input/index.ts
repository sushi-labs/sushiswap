...
export const DEFAULT_INPUT_CLASSNAME =
  'rounded-xl bg-slate-800 py-3 px-4 text-left shadow-md border-none text-sm font-bold focus:ring-1 focus-within:ring-1 ring-offset-2 ring-offset-slate-900 ring-blue'
