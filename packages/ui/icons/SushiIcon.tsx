...
export const SushiIcon = (props: React.ComponentProps<'svg'>) => {
  return (
    <svg
      ...
      strokeMiterlimit="2"
    >
      <path fill="none" d="M0 0h1920v1080H0z" transform="scale(.26667 .47407)" />
      <path
        fill="#fff"
      ...
      <path
        ...
        transform="matrix(2.22208 0 0 2.22208 -41234.303 -35478.769)"
      />
      <defs>
        <linearGradient
          id="b"
        ...
        >
          <stop offset="0" stopColor="#27b0e6" stopOpacity="1" />
          <stop offset=".52" stopColor="#c26bb3" stopOpacity="1" />
          <stop offset="1" stopColor="#fa52a0" stopOpacity="1" />
        </linearGradient>
      </defs>
    </svg>
  )
