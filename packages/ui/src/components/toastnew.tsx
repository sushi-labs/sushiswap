...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={classNames(
      'group fixed z-[50] bottom-6 right-6 !transition-[transform_.4s_ease,_bottom_.4s_ease] hover:translate-y-[-10px]',
      className,
    )}
    {...props}
  />
