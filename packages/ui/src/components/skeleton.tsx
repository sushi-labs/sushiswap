...
const skeletonBgColorClassName = "bg-black/[0.10] dark:bg-white/[0.10] black:bg-white/[0.25]";
const skeletonFillColorClassName = "fill-black/[0.10] dark:fill-white/[0.10] black:fill-white/[0.25]";
...
function SkeletonChartLoadingStateMask({ type, height }: { type: ChartType; height: number }) {
	switch (type) {
		case "area":
			return (
				<g transform={`translate(0, ${height}) scale(1,-1)`}>
					<defs>
						<pattern id="wavePattern" patternUnits="userSpaceOnUse" width="200" height={height}>
							<path
					...
					<rect width="100%" height={height} fill="url(#wavePattern)" className="animate-pulse" />
				</g>
			);
		case "bar":
			return (
