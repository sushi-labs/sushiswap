...
export const TronNaked: NakedNetworkIconComponent = (props) => (
  <svg
    viewBox={props.circle ? '0 0 96 96' : '0 0 64 64'}
    xmlns="http://www.w3.org/2000/svg"
    {...props}
    fill={props.circle ? 'currentColor' : '#ff060a'}
    className={classNames(props.className)}
  >
    {props.circle}
    <g transform={props.circle ? 'translate(20,20)' : ''}>
