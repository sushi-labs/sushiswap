...
export const BUTTON_CLASSES: Record<string, string> = {
  ...
  "btn-empty": "!ring-0",
  "btn-outlined":
    "border-2 hover:ring-2 border-opacity-20 ring-offset-2 ring-offset-slate-900 rounded-xl",
  "btn-outlined-red":
    "border-2 hover:ring-2 border-opacity-20 ring-offset-2 ring-offset-slate-900 rounded-xl",
  ...
  "btn-filled-gradient":
    "bg-gradient-to-r hover:ring-4 !ring-pink/20 from-blue-600 to-pink-600 focus:border-blue-700",
