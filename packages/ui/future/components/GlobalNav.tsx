  ...
  return (
    <header
      ...
      className={classNames(
        showBackground
          ? 'lg:bg-white/50 paper lg:dark:bg-slate-800/50 lg:dark:border-slate-200/5 lg:border-gray-300/70 lg:border-b'
            ...
            <Menu as="div" className="relative" onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
              ...
              >
                <div className="absolute pt-2 w-[max-content]">
                  <Menu.Items className="rounded-2xl p-3 w-[max-content] bg-white/50 shadow-md dark:bg-slate-800/50 paper !max-h-[unset]">
                    <a
