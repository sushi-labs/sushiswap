...
describe('AddressMapper', () => {
  ...
  test('when kovan address is given, return all eth and ropsten addresses', async () => {
    ...
    const expected = {
      '1:0x0000000000000000000000000000000000000101': [
        ...
        { chainId: 3, tokenAddress: '0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c' },
        { chainId: 4, tokenAddress: '0x1717a0d5c8705ee89a8ad6e808268d6a826c97a4' },
      ],
      '1:0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48': [
        { chainId: 1, tokenAddress: '0x0000000000000000000000000000000000000101' },
        { chainId: 3, tokenAddress: '0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c' },
        { chainId: 4, tokenAddress: '0x1717a0d5c8705ee89a8ad6e808268d6a826c97a4' },
      ],
      '3:0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c': [
  ...
  test.each([
    {
      ...
      filter: 3,
      expected: [{ chainId: 3, tokenAddress: '0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c' }],
    },
    {
      chainId: 3,
  ...
  test('Wrapped BTT is not mapped to other wrapped natives', async () => {
    const actual = TOKEN_MAP[`${ChainId.BTTC}:${WNATIVE_ADDRESS[ChainId.BTTC].toLowerCase()}`]
