...
describe('AddressMapper', () => {
  ...
  test('when kovan address is given, return all eth and ropsten addresses', async () => {
    ...
    expect(actual['1:0x0000000000000000000000000000000000000101'][1]).toEqual([
  ...
  test.each([
    {
      ...
      filter: 3,
      expected: ['0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c'],
    },
    {
      chainId: 3,
      address: '0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c',
      filter: 1,
      expected: ['0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48', '0x0000000000000000000000000000000000000101'],
    },
    {
      chainId: 3,
      address: '0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c',
  ...
  test('BTTC has 3 usdc addresses', async () => {
    const actual = Object.values(
      TOKEN_MAP[`${ChainId.BTTC}:${USDC_ADDRESS[ChainId.BTTC].toLowerCase()}`][ChainId.BTTC]
    ).length
