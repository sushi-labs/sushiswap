...
import { Percent, sqrt } from 'sushi/math'
...
describe('Trade', () => {
  ...
  describe('#worstExecutionPrice', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('returns exact if nonzero with multiple routes', () => {
        expect(
          exactInMultiRoute.worstExecutionPrice(new Percent(0, 100)),
        ).toEqual(new Price(token0, token2, 100, 69))
        expect(
          exactInMultiRoute.worstExecutionPrice(new Percent(5, 100)),
        ).toEqual(new Price(token0, token2, 100, 65))
        expect(
          exactInMultiRoute.worstExecutionPrice(new Percent(200, 100)),
        ).toEqual(new Price(token0, token2, 100, 23))
      })
    })
    describe('tradeType = EXACT_OUTPUT', () => {
      ...
      it('returns slippage amount if nonzero', () => {
        expect(
          exactOut
            .worstExecutionPrice(new Percent(0, 100))
            .equalTo(new Price(token0, token2, 156, 100)),
        ).toBeTruthy()
        expect(
          exactOut
            .worstExecutionPrice(new Percent(5, 100))
            .equalTo(new Price(token0, token2, 163, 100)),
        ).toBeTruthy()
        expect(
          exactOut
            .worstExecutionPrice(new Percent(200, 100))
            .equalTo(new Price(token0, token2, 468, 100)),
        ).toBeTruthy()
      })
      it('returns exact if nonzero with multiple routes', () => {
        expect(
  ...
  describe('#priceImpact', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('is correct with multiple routes', async () => {
        expect(exactInMultipleRoutes.priceImpact.toSignificant(3)).toEqual(
          '19.8',
        )
      })
    })
    describe('tradeType = EXACT_OUTPUT', () => {
      ...
      it('is correct with multiple routes', () => {
        expect(exactOutMultipleRoutes.priceImpact.toSignificant(3)).toEqual(
          '25.5',
        )
      })
    })
  ...
  describe('#bestTradeExactIn', () => {
    ...
    it('provides best route', async () => {
      ...
      expect(
        result[0].outputAmount.equalTo(
          CurrencyAmount.fromRawAmount(token2, 9971n),
        ),
      ).toBeTruthy()
      ...
      expect(
        result[1].outputAmount.equalTo(
          CurrencyAmount.fromRawAmount(token2, 7004n),
        ),
      ).toBeTruthy()
    })
    ...
    it('works for ETHER currency input', async () => {
      ...
      expect(result[0].swaps[0].route.tokenPath).toEqual([
        WETH9[1],
        token0,
        token1,
        token3,
  ...
  describe('#maximumAmountIn', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() => exactIn.maximumAmountIn(new Percent(-1n, 100n))).toThrow(
          'SLIPPAGE_TOLERANCE',
        )
      })
      it('returns exact if 0', () => {
        expect(exactIn.maximumAmountIn(new Percent(0n, 100n))).toEqual(
          exactIn.inputAmount,
        )
      })
      it('returns exact if nonzero', () => {
    ...
    describe('tradeType = EXACT_OUTPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() => exactOut.maximumAmountIn(new Percent(-1n, 10000))).toThrow(
          'SLIPPAGE_TOLERANCE',
        )
      })

      it('returns exact if 0', () => {
        expect(exactOut.maximumAmountIn(new Percent(0n, 10000))).toEqual(
  ...
  describe('#minimumAmountOut', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('returns exact if 0', () => {
        expect(exactIn.minimumAmountOut(new Percent(0n, 10000))).toEqual(
    ...
    describe('tradeType = EXACT_OUTPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() => exactOut.minimumAmountOut(new Percent(-1n, 100n))).toThrow(
          'SLIPPAGE_TOLERANCE',
        )
      })
      it('returns exact if 0', () => {
        expect(exactOut.minimumAmountOut(new Percent(0n, 100n))).toEqual(
