...
const querySchema3_1 = querySchema.extend({
  chainId: z.coerce
    ...
    .lte(2 ** 256)
    .default(ChainId.ETHEREUM)
    .refine((chainId) => isSupportedChainId(chainId) && isRouteProcessor3_1ChainId(chainId), {
...
const querySchema3_2 = querySchema.extend({
  chainId: z.coerce
    ...
    .lte(2 ** 256)
    .default(ChainId.ETHEREUM)
    .refine((chainId) => isSupportedChainId(chainId) && isRouteProcessor3_2ChainId(chainId), {
      message: 'ChainId not supported.',
    })
