...
export const EXTRACTOR_CONFIG = {
  ...
  [ChainId.ARBITRUM_NOVA]: {
    ...
    tickHelperContract: V3_TICK_LENS[ChainId.ARBITRUM_NOVA],
    cacheDir: './cache',
    logDepth: 300,
    logging: true,
  ...
  [ChainId.AVALANCHE]: {
    ...
    tickHelperContract: V3_TICK_LENS[ChainId.AVALANCHE],
    cacheDir: './cache',
    logDepth: 50,
    logging: true,
  ...
  [ChainId.BOBA]: {
    ...
    tickHelperContract: V3_TICK_LENS[ChainId.BOBA],
    cacheDir: './cache',
    logDepth: 50,
    logging: true,
  ...
  [ChainId.BOBA_AVAX]: {
    ...
    factoriesV3: [],
    tickHelperContract: V3_TICK_LENS[ChainId.BOBA_AVAX],
    cacheDir: './cache',
    logDepth: 50,
    logging: true,
  ...
  [ChainId.BOBA_BNB]: {
    ...
    factoriesV3: [],
    tickHelperContract: V3_TICK_LENS[ChainId.BOBA_BNB],
    cacheDir: './cache',
    logDepth: 50,
    logging: true,
  ...
  [ChainId.BSC]: {
    ...
    tickHelperContract: V3_TICK_LENS[ChainId.BSC],
    cacheDir: './cache',
    logDepth: 1000,
    logging: true,
  ...
  [ChainId.CELO]: {
    ...
    tickHelperContract: V3_TICK_LENS[ChainId.CELO],
    cacheDir: './cache',
    logDepth: 50,
    logging: true,
  ...
  [ChainId.FANTOM]: {
    ...
    tickHelperContract: V3_TICK_LENS[ChainId.FANTOM],
    cacheDir: './cache',
    logDepth: 300,
    logging: true,
