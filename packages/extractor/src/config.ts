...
import { Address, createPublicClient, Hex } from 'viem'

import { LogFilterType } from './LogFilter2'
  ...
  [ChainId.ARBITRUM]: {
    ...
    factoriesV2: [
      sushiswapV2Factory(ChainId.ARBITRUM),
      {
        ...
        fee: 0.003,
        initCodeHash: '0xd49917af2b31d70ba7bea89230a93b55d3b6a99aacd03a72c288dfe524ec2f36' as Hex,
      },
      {
        address: '0xA59B2044EAFD15ee4deF138D410d764c9023E1F0' as Address,
        provider: LiquidityProviders.Elk,
        fee: 0.003,
        initCodeHash: '0x84845e7ccb283dec564acfcd3d9287a491dec6d675705545a2ab8be22ad78f31' as Hex,
      },
    ],
  ...
  [ChainId.AVALANCHE]: {
    ...
    factoriesV2: [
      sushiswapV2Factory(ChainId.AVALANCHE),
      {
        ...
        fee: 0.003,
        initCodeHash: '0x0bbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91' as Hex,
      },
    ],
  ...
  [ChainId.BSC]: {
    ...
    factoriesV2: [
      ...
      },
      {
        ...
        fee: 0.002,
        initCodeHash: '0xfea293c909d87cd4153593f077b76bb7e94340200f4ee84211ae8e4f9bd7ffdf' as Hex,
      },
      {
        address: '0x0841BD0B734E4F5853f0dD8d7Ea041c241fb0Da6' as Address,
        provider: LiquidityProviders.ApeSwap,
        fee: 0.003,
        initCodeHash: '0xf4ccce374816856d11f00e4069e7cada164065686fbef53c6167a63ec2fd8c5b' as Hex,
      },
      {
        address: '0x0eb58E5c8aA63314ff5547289185cC4583DfCBD5' as Address,
        provider: LiquidityProviders.JetSwap,
        fee: 0.003,
        initCodeHash: '0x3125d0a15fa7af49ce234ba1cf5f931bad0504242e0e1ee9fcd7d1d7aa88c651' as Hex,
      },
    ],
  ...
  [ChainId.ETHEREUM]: {
    ...
    factoriesV2: [
      ...
      sushiswapV2Factory(ChainId.ETHEREUM),
      {
        ...
        provider: LiquidityProviders.ApeSwap,
        fee: 0.003,
        initCodeHash: '0xe2200989b6f9506f3beca7e9c844741b3ad1a88ad978b6b0973e96d3ca4707aa' as Hex,
      },
      {
  ...
  [ChainId.FANTOM]: {
    ...
    factoriesV2: [
      sushiswapV2Factory(ChainId.FANTOM),
      {
        ...
        provider: LiquidityProviders.Dfyn,
        fee: 0.003,
        initCodeHash: '0xd3ab2c392f54feb4b3b2a677f449b133c188ad2f1015eff3e94ea9315282c5f5' as Hex,
      },
      {
      ...
      },
      {
        ...
        fee: 0.003,
        initCodeHash: '0xcdf2deca40a0bd56de8e3ce5c7df6727e5b1bf2ac96f283fa9c4b3e6b42ea9d2' as Hex,
      },
    ],
    factoriesV3: [
      sushiswapV3Factory(ChainId.FANTOM),
      {
        ...
        initCodeHash: '0x30146866f3a846fe3c636beb2756dbd24cf321bc52c9113c837c21f47470dfeb' as Hex,
      },
    ],
  ...
  [ChainId.POLYGON]: {
    ...
    factoriesV2: [
      ...
      },
      {
        ...
        provider: LiquidityProviders.ApeSwap,
        fee: 0.003,
        initCodeHash: '0x511f0f358fe530cda0859ec20becf391718fdf5a329be02f4c95361f3d6a42d8' as Hex,
      },
      {
        address: '0xE7Fb3e833eFE5F9c441105EB65Ef8b261266423B' as Address,
        provider: LiquidityProviders.Dfyn,
        fee: 0.003,
        initCodeHash: '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3' as Hex,
      },
      {
      ...
      },
      {
        ...
        provider: LiquidityProviders.JetSwap,
        fee: 0.003,
        initCodeHash: '0x505c843b83f01afef714149e8b174427d552e1aca4834b4f9b4b525f426ff3c6' as Hex,
      },
    ],
  ...
  [ChainId.POLYGON_ZKEVM]: {
    ...
    factoriesV3: [
      sushiswapV3Factory(ChainId.POLYGON_ZKEVM),
      {
        ...
        initCodeHash: '0xd3e7f58b9af034cfa7a0597e539bae7c6b393817a47a6fc1e1503cd6eaffe22a' as Hex,
      },
    ],
  ...
  [ChainId.BASE]: {
    ...
    factoriesV2: [
      sushiswapV2Factory(ChainId.BASE),
      {
        ...
        fee: 0.0025,
        initCodeHash: '0xb618a2730fae167f5f8ac7bd659dd8436d571872655bcb6fd11f2158c8a64a3b' as Hex,
      },
    ],
