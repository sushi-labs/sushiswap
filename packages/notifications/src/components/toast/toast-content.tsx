...
export const ToastContent: FC<ToastContent> = ({ icon, href, description, summary, code = false }) => {
	...
	return (
		<div className="pt-5 pb-4 px-6 flex gap-4 items-start sm:min-w-[350px]">
			...
			<div className="flex flex-col gap-1 overflow-hidden">
				{!code ? (
					<>
						<span className="font-medium text-sm text-muted-foreground">{summary}</span>
