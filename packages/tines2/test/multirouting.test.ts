...
describe('Multirouting for bridge topology', () => {
  ...
  //   for (let i = 0; i < 10_000_000; ++i) pool.calcOutByIn2(amountIn * i, i % 2 == 0)
  //   const start1 = performance.now()
  //   for (let i = 0; i < 10_000_000; ++i) pool.calcInByOut2(amountIn * i, i % 2 == 0)
  //   const start2 = performance.now()
  //   for (let i = 0; i < 10_000_000; ++i) pool.calcCurrentPriceWithoutFee2(i % 2 == 0)
  ...
  //   console.log(`ConstantProduct pool calcOutByIn2: ${t1}ms, calcInByOut2: ${t2}ms, price: ${t3}ms`)
  // })
})
