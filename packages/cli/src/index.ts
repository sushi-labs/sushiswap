...
program
  ...
  .option(
    "-n,--network <NETWORK>",
    "network available: ".concat(REVENUES_SUPPORTED_CHAIN_NAMES.join(", "))
  )
...
program
  ...
  .option(
    "-n,--network <NETWORK>",
    "network available: ".concat(FURO_SUPPORTED_CHAIN_NAMES.join(", "))
  )
  .action(furo);
...
program
  ...
  .option(
    "-n,--network <NETWORK>",
    "network available: ".concat(
      Object.keys(MAKER_SUPPORTED_CHAIN_NAMES).join(", ")
    )
  )
  .option("-v,--verbose", "includes table data")
  .action(maker);
