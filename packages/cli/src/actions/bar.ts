...
export async function bar(args: Arguments) {
  ...
  table.push([
    ...
    chalk.bold.green(
      numeral(
        (bar?.sushiXsushiRatio / oneMonthBar?.sushiXsushiRatio - 1) * 12
      ).format("0.00%")
    ),
  ...
  table.push([
    ...
    chalk.bold.green(
      numeral(
        (bar?.sushiXsushiRatio / threeMonthBar?.sushiXsushiRatio - 1) * 4
      ).format("0.00%")
    ),
  ...
  table.push([
    ...
    chalk.bold.green(
      numeral(
        (bar?.sushiXsushiRatio / sixMonthBar?.sushiXsushiRatio - 1) * 2
      ).format("0.00%")
    ),
  ...
  table.push([
    chalk.blue("APR 1y"),
    chalk.bold.green(
      numeral(bar?.sushiXsushiRatio / oneYearBar?.sushiXsushiRatio - 1).format(
        "0.00%"
      )
    ),
