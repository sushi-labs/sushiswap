 ...
 */
export type FactoryDataKey = {tag: "Factory", values: void} | {tag: "XlmAddress", values: void};
 ...
 */
export type ComplianceHookDataKey = {tag: "HookModules", values: readonly [ComplianceHook]} | {tag: "ModuleRegistered", values: readonly [ComplianceHook, string]};
