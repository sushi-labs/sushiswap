...
export const networks = {
  testnet: {
    ...
    contractId: "CDGVLDFHUDZOIKAKPMUW7XLFCZSW3CZA7SIQFG5FRUOIIX3JLUEVOVXY",
  }
} as const
...
export interface Client {
   ...
   * 
   * # Returns
   * * `Ok((fee0, fee1, slot_hint))` - Fees that must be repaid and current oracle slot hint for swaps
   */
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
  ...
  public readonly fromJSON = {
    check_ticks: this.txFromJSON<Result<void>>,
        ...
        flash_begin: this.txFromJSON<Result<readonly [u128, u128, u128]>>,
