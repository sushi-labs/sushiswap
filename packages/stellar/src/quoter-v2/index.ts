...
export const networks = {
  testnet: {
    ...
    contractId: "CCSNP56ATAO3ZQ3CGPNT4JLGJ3PRF3YLJ3UQTSCISOPBPL6GC3QQONBU",
  }
} as const
...
export interface Client {
   ...
   */
  get_pool_address: ({token_a, token_b, fee}: {token_a: string, token_b: string, fee: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  quote_exact_input_single: ({params}: {params: QuoteExactInputSingleParams}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  quote_exact_output_single: ({params}: {params: QuoteExactOutputSingleParams}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAAG1F1b3RlRXhhY3RJbnB1dFNpbmdsZVBhcmFtcwAAAAAFAAAAAAAAAAlhbW91bnRfaW4AAAAAAAALAAAAAAAAAANmZWUAAAAABAAAAAAAAAAUc3FydF9wcmljZV9saW1pdF94OTYAAAAMAAAAAAAAAAh0b2tlbl9pbgAAABMAAAAAAAAACXRva2VuX291dAAAAAAAABM=",
        "AAAAAQAAAAAAAAAAAAAAHFF1b3RlRXhhY3RPdXRwdXRTaW5nbGVQYXJhbXMAAAAFAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAAAAAAA2ZlZQAAAAAEAAAAAAAAABRzcXJ0X3ByaWNlX2xpbWl0X3g5NgAAAAwAAAAAAAAACHRva2VuX2luAAAAEwAAAAAAAAAJdG9rZW5fb3V0AAAAAAAAEw==",
        "AAAAAAAAAAAAAAAEaW5pdAAAAAIAAAAAAAAAB2ZhY3RvcnkAAAAAEwAAAAAAAAADeGxtAAAAABMAAAAA",
        "AAAAAAAAAAAAAAAQZ2V0X3Bvb2xfYWRkcmVzcwAAAAMAAAAAAAAAB3Rva2VuX2EAAAAAEwAAAAAAAAAHdG9rZW5fYgAAAAATAAAAAAAAAANmZWUAAAAABAAAAAEAAAAT",
        "AAAAAAAAAAAAAAAYcXVvdGVfZXhhY3RfaW5wdXRfc2luZ2xlAAAAAQAAAAAAAAAGcGFyYW1zAAAAAAfQAAAAG1F1b3RlRXhhY3RJbnB1dFNpbmdsZVBhcmFtcwAAAAABAAAACw==",
        "AAAAAAAAAAAAAAAZcXVvdGVfZXhhY3Rfb3V0cHV0X3NpbmdsZQAAAAAAAAEAAAAAAAAABnBhcmFtcwAAAAAH0AAAABxRdW90ZUV4YWN0T3V0cHV0U2luZ2xlUGFyYW1zAAAAAQAAAAs=",
        "AAAAAAAAAAAAAAARcXVvdGVfZXhhY3RfaW5wdXQAAAAAAAACAAAAAAAAAARwYXRoAAAADgAAAAAAAAAJYW1vdW50X2luAAAAAAAACwAAAAEAAAAL",
        "AAAAAAAAAAAAAAAScXVvdGVfZXhhY3Rfb3V0cHV0AAAAAAACAAAAAAAAAARwYXRoAAAADgAAAAAAAAAKYW1vdW50X291dAAAAAAACwAAAAEAAAAL",
  ...
  public readonly fromJSON = {
    init: this.txFromJSON<null>,
        get_pool_address: this.txFromJSON<string>,
        quote_exact_input_single: this.txFromJSON<i128>,
        quote_exact_output_single: this.txFromJSON<i128>,
        quote_exact_input: this.txFromJSON<i128>,
        quote_exact_output: this.txFromJSON<i128>,
