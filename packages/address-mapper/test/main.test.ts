...
beforeAll(() => {
    const expected: Map<string, Map<number, string>> = new Map([
        [
            '1:0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48', new Map([
                [4, "0x1717a0d5c8705ee89a8ad6e808268d6a826c97a4"],
                [3, "0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c"]
            ])
        ],
        [
            '4:0x1717a0d5c8705ee89a8ad6e808268d6a826c97a4', new Map([
                [1, "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"],
                [3, "0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c"]
            ])
        ],
        [
            '3:0x0d9c8723b343a8368bebe0b5e89273ff8d712e3c', new Map([
                [1, "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"],
                [4, "0x1717a0d5c8705ee89a8ad6e808268d6a826c97a4"],
            ])
        ],
        [
            '1:0x6b3595068778dd592e39a122f4f5a5cf09c90fe2', new Map([
                [4, "0x0769fd68dfb93167989c6f7254cd0d766fb2841f"],
                [3, "0x0769fd68dfb93167989c6f7254cd0d766fb2841f"],
            ])
        ],
        [
            '4:0x0769fd68dfb93167989c6f7254cd0d766fb2841f', new Map([
                [1, "0x6b3595068778dd592e39a122f4f5a5cf09c90fe2"],
                [3, "0x0769fd68dfb93167989c6f7254cd0d766fb2841f"],
            ])
        ],
        [
            '3:0x0769fd68dfb93167989c6f7254cd0d766fb2841f', new Map([
                [1, "0x6b3595068778dd592e39a122f4f5a5cf09c90fe2"],
                [4, "0x0769fd68dfb93167989c6f7254cd0d766fb2841f"],
            ])
        ],
    ...
    expect(addressMapper.allAddresses()).toEqual(expected)
})
...
describe("AddressMapper", () => {
    ...
    describe("Ignore lower case", () => {
        ...
        expect(mapper.allAddresses()).toEqual(expected)
