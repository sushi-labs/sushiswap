    ...
    >
      <div className="grid grid-cols-2 items-center w-full mx-auto z-[101] px-4">
        <div className="flex items-center gap-2">
          <a
            className="flex flex-row items-center sm:pl-2 pr-4 sm:pr-6"
            href="/"
          >
            ...
            >
              <div className="absolute pt-2 w-[max-content]">
                <Menu.Items className="rounded-2xl p-3 w-[max-content] bg-white shadow-md dark:bg-slate-700 !max-h-[unset]">
                  ...
                  >
                    Discover Sushi{" "}
                    <ArrowRightIcon width={18} height={18} strokeWidth={20} />
                  </a>
...
export const MenuItem: FC<{ subtitle: string; type: AppType }> = ({
  subtitle,
  type,
}) => {
  ...
  return (
    ...
    >
      ...
      <ArrowRightIcon
        width={16}
        height={16}
        className="hidden hover:flex absolute right-2"
      />
      <Transition
        as={Fragment}
        show={hover}
