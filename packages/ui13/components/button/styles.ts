...
export const BUTTON_CLASSES: Record<string, string> = {
  ...
  'btn-empty': '',
  'btn-outlined': '',
  'btn-outlined-red': 'bg-red/10 hover:bg-red/20 active:bg-red/30 text-red',
  'btn-outlined-blue': 'bg-blue/10 hover:bg-blue/20 active:bg-blue/30 text-blue',
  ...
  'btn-filled-gray':
    'bg-white dark:bg-slate-800 hover:dark:bg-slate-700 hover:active:bg-slate-600 text-gray-900 dark:text-white',
