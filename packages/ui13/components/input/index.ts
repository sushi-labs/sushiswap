...
// Base classes
export const DEFAULT_INPUT_FONT =
  "text-left text-base md:text-sm placeholder:font-normal font-medium";
...
export const DEFAULT_INPUT_APPEARANCE =
  "rounded-xl shadow-md min-h-[44px] w-full truncate";
export const DEFAULT_INPUT_NO_RINGS =
