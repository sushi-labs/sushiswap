...
export type UseSendTransactionConfig = Parameters<typeof useSendTransaction_>['0']
...
export function useSendTransaction({ prepare, send, gasMargin = false }: UseSendTransaction) {
