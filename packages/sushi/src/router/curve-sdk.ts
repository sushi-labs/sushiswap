...
function _curvePoolFilter(pool: RPool): string {
  switch (pool.address) {
    ...
    case '0xAe9e8c9A548505c9ad22a412354186151363c09e': // 46/534
      return 'Temporary unsupported: pool init error'
    case '0x2dabF79E16ceb92B651651f47b6E835C9DB5828A': // 55/534
      return 'Temporary unsupported: pool init error'
    case '0x69B6dA941E6A8960f480709281b87B1C32fF8366': // 57/534
      return 'Temporary unsupported: swap error'
    case '0xfEF79304C80A694dFd9e603D624567D470e1a0e7': // 58/534
      return 'Temporary unsupported: swap error'
    case '0x1539c2461d7432cc114b0903f1824079BfCA2C92': // 59/534
      return 'Temporary unsupported: swap error'
    case '0x2B26239f52420d11420bC0982571BFE091417A7d': // 77/534
      return 'Temporary unsupported: swap error'
    case '0x8461A004b50d321CB22B7d034969cE6803911899': // 176/534
      return 'Temporary unsupported: pool init error'
    case '0x621F13Bf667207335C601F8C89eA5eC260bAdA9A': // 178/534
      return 'Temporary unsupported: pool init error'
    case '0xDa5B670CcD418a187a3066674A8002Adc9356Ad1': // 181/534
      return 'Temporary unsupported: pool init error'
    case '0x6A274dE3e2462c7614702474D64d376729831dCa': // 183/534
      return 'Temporary unsupported: swap error'
    case '0x3CFAa1596777CAD9f5004F9a0c443d912E262243': // 187/534
      return 'Temporary unsupported: ???'
    case '0x8818a9bb44Fbf33502bE7c15c500d0C783B73067': // 190/534
      return 'Temporary unsupported: pool init error'
    case '0x3F1B0278A9ee595635B61817630cC19DE792f506': // 191/534
      return 'Temporary unsupported: pool init error'
    case '0xD6Ac1CB9019137a896343Da59dDE6d097F710538': // 192/534
      return 'Temporary unsupported: pool init error'
    case '0x9c2C8910F113181783c249d8F6Aa41b51Cde0f0c': // 193/534
      return 'Temporary unsupported: pool init error'
    case '0xFB9a265b5a1f52d97838Ec7274A0b1442efAcC87': // 218/534
      return 'Temporary unsupported: pool init error'
    case '0x8ed10E4e307822b969BCDaffD49095235f6F892b': // 242/534
      return 'Temporary unsupported: ???'
    case '0x97aEB34ac6561146DD9cE191EFD5634F6465DeF4': // 247/534
      return 'Temporary unsupported: pool init error'
