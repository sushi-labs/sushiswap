...
export const STARGATE_DEFAULT_BLOCK_CONFIRMATIONS: Record<keyof typeof STARGATE_CHAIN_ID, number> = {
  [ChainId.ETHEREUM]: 15,
  [ChainId.BSC]: 20,
...
export const STARGATE_CONFIRMATION_SECONDS: Record<keyof typeof STARGATE_CHAIN_ID, number> = {
  [ChainId.ETHEREUM]:
