...
export const ADDITIONAL_BASES: {
  ...
  [ChainId.FLARE]: {
    [ENOSYS_BNZ.address]: [WNATIVE[ChainId.FLARE]],
    [ENOSYS_EETH.address]: [WNATIVE[ChainId.FLARE]],
    [WNATIVE_ADDRESS[ChainId.FLARE]]: [ENOSYS_BNZ, ENOSYS_EETH],
    [ENOSYS_EQNT.address]: [ENOSYS_HLN],
    [ENOSYS_HLN.address]: [ENOSYS_APS, ENOSYS_EQNT],
    [ENOSYS_APS.address]: [ENOSYS_HLN],
  },
}
