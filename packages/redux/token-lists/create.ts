...
type ParamsWithoutContext<T extends (...args: any) => any> =
...
export type TokenListHooks = {
  useAllLists: (
    ...args: ParamsWithoutContext<typeof _useAllLists>
  ) => ReturnType<typeof _useAllLists>;
  useActiveListUrls: (
    ...args: ParamsWithoutContext<typeof _useActiveListUrls>
  ) => ReturnType<typeof _useActiveListUrls>;
  useInactiveListUrls: (
  ...
  useIsListActive: (
    ...args: ParamsWithoutContext<typeof _useIsListActive>
  ) => ReturnType<typeof _useIsListActive>;
  useFetchListCallback: (
    ...args: ParamsWithoutContext<typeof _useFetchListCallback>
  ) => ReturnType<typeof _useFetchListCallback>;
  useTokens: (
    ...args: ParamsWithoutContext<typeof _useTokensCallback>
  ) => ReturnType<typeof _useTokensCallback>;
};
...
export function createTokenLists(options?: TokenListsOptions): {
  ...
  const useAllLists = (...args: ParamsWithoutContext<typeof _useAllLists>) =>
    _useAllLists(context, ...args);
  const useActiveListUrls = (
    ...args: ParamsWithoutContext<typeof _useActiveListUrls>
  ) => _useActiveListUrls(context, ...args);
  const useInactiveListUrls = (
    ...args: ParamsWithoutContext<typeof _useInactiveListUrls>
  ) => _useInactiveListUrls(context, ...args);
  const useCombinedActiveList = (
    ...args: ParamsWithoutContext<typeof _useCombinedActiveList>
  ) => _useCombinedActiveList(context, ...args);
  const useUnsupportedTokenList = (
    ...args: ParamsWithoutContext<typeof _useUnsupportedTokenList>
  ) => _useUnsupportedTokenList(context, ...args);
  const useIsListActive = (
    ...args: ParamsWithoutContext<typeof _useIsListActive>
  ) => _useIsListActive(context, ...args);
  const useFetchListCallback = (
    ...args: ParamsWithoutContext<typeof _useFetchListCallback>
  ) => _useFetchListCallback(context, ...args);
  const useTokens = (
    ...args: ParamsWithoutContext<typeof _useTokensCallback>
  ) => _useTokensCallback(context, ...args);
