...
export type StorageHooks = {
  useSettings: (
    ...args: ParamsWithoutContext<typeof _useSettings>
  ) => ReturnType<typeof _useSettings>;
  useCustomTokens: (
    ...args: ParamsWithoutContext<typeof _useCustomTokens>
  ) => ReturnType<typeof _useCustomTokens>;
  useAllCustomTokens: (
    ...args: ParamsWithoutContext<typeof _useAllCustomTokens>
  ) => ReturnType<typeof _useAllCustomTokens>;
  useNotifications: (
    ...args: ParamsWithoutContext<typeof _useNotifications>
  ) => ReturnType<typeof _useNotifications>;
};
...
export function createStorage(options?: StorageOptions): {
  ...
  const useCustomTokens = (chainId?: number) =>
    _useCustomTokens(context, chainId);
  const useAllCustomTokens = () => _useAllCustomTokens(context);
  const useNotifications = (account: string | undefined) =>
    _useNotifications(context, account);
