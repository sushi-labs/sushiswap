...
const reducers = {
  updateCarbonOffset: (
    state: StorageState,
    action: PayloadAction<UpdateCarbonOffsetPayload>
  ) => {
  ...
  updateExpertMode: (
    state: StorageState,
    action: PayloadAction<UpdateExpertMode>
  ) => {
  ...
  updateSushiGuard: (
    state: StorageState,
    action: PayloadAction<UpdateSushiGuard>
  ) => {
  ...
  updateSlippageTolerance: (
    state: StorageState,
    action: PayloadAction<UpdateSlippageTolerancePayload>
  ) => {
  ...
  updateSlippageToleranceType: (
    state: StorageState,
    action: PayloadAction<UpdateSlippageToleranceTypePayload>
  ) => {
  ...
  updateGasPrice: (
    state: StorageState,
    action: PayloadAction<UpdateGasPrice>
  ) => {
  ...
  updateMaxFeePerGas: (
    state: StorageState,
    action: PayloadAction<UpdateMaxFeePerGas>
  ) => {
  ...
  updateMaxPriorityFeePerGas: (
    state: StorageState,
    action: PayloadAction<UpdateMaxPriorityFeePerGas>
  ) => {
  ...
  updateGasType: (
    state: StorageState,
    action: PayloadAction<UpdateGasType>
  ) => {
  ...
  addCustomToken: (
    state: StorageState,
    action: PayloadAction<AddCustomToken>
  ) => {
  ...
  addCustomTokens: (
    state: StorageState,
    action: PayloadAction<AddCustomTokens>
  ) => {
  ...
  removeCustomToken: (
    state: StorageState,
    action: PayloadAction<RemoveCustomToken>
  ) => {
  ...
  updateTransactionDeadline: (
    state: StorageState,
    action: PayloadAction<UpdateTransactionDeadline>
  ) => {
  ...
  createNotification: (
    state: StorageState,
    action: PayloadAction<createNotification>
  ) => {
  ...
  clearNotifications: (
    state: StorageState,
    action: PayloadAction<ClearNotifications>
  ) => {
