...
import { arbitrum, avalanche, bsc, fantom, foundry, goerli, hardhat, localhost, mainnet, optimism, polygon, polygonZkEvm, telos, zkSync, } from '@wagmi/core/chains';
export var defaultChains = [
    arbitrum,
    // arbitrumGoerli,
    avalanche,
    // avalancheFuji,
...
export var otherChains = [
    ...
    __assign(__assign({}, polygonZkEvm), { id: ChainId.POLYGON_ZKEVM, contracts: {
            multicall3: {
                address: '0xcA11bde05977b3631167028862bE2a173976CA11',
                blockCreated: 57746,
            },
    ...
    __assign(__assign({}, telos), { id: ChainId.TELOS }),
    {
        id: ChainId.LINEA,
        name: 'Linea',
        network: 'linea',
...
export var allChains = __spreadArray(__spreadArray([], defaultChains, true), otherChains, true);
