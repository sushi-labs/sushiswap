...
export const ADDITIONAL_BASES: {
  ...
  [ChainId.POLYGON]: {
    [THREE_ADDRESS[ChainId.POLYGON]]: [DAI, WMATIC, AAVE, LINK, MANA, SNX, CRV, WBTC, YFI, ENJ, XSUSHI[ChainId.POLYGON]],
  }.
  [ChainId.POLYGON]: {
    [THREE_ADDRESS[ChainId.POLYGON]]: [THREE[ChainId.POLYGON]],
    [WMATIC_ADDRESS[ChainId.POLYGON]]: [WMATIC[ChainId.POLYGON]],
    [LINK_ADDRESS[ChainId.POLYGON]]: [LINK[ChainId.POLYGON]],
    [DAI_ADDRESS[ChainId.POLYGON]]: [DAI[ChainId.POLYGON]],
    [AAVE_ADDRESS[ChainId.POLYGON]]: [AAVE[ChainId.POLYGON]],
  },
  [ChainId.ARBITRUM]: {
