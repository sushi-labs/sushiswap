...
export const BLOCKS_SUBGRAPH_URL: Record<number, string> = {
  ...
  [ChainId.FANTOM]: `${DECENTRALIZED_NETWORK_HOST}/3drjZDpA9hAuYGA19ttEkhW432mVe2XHy5YarBDVYHbz`,
  ...
  [ChainId.ARBITRUM]: `${DECENTRALIZED_NETWORK_HOST}/5jebsN6RBioFWQX7LP2N8r55nL4QPAyeKc6GzDA1Pt5H`,
  ...
  [ChainId.OPTIMISM]: `${DECENTRALIZED_NETWORK_HOST}/HsWM1oAXHGWdkH8bK98UrW38PvyPx6Q4waRow2LT8mcp`,
...
export const SUSHISWAP_V2_SUBGRAPH_URL: Record<number, string> = {
  ...
  [ChainId.KAVA]: `${DECENTRALIZED_NETWORK_HOST}/sushi-v2/v2-kava/gn`,
